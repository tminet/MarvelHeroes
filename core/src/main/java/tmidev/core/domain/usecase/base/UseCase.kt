...
abstract class UseCasePaging<in P, R : Any> {
    operator fun invoke(params: P): Flow<PagingData<R>> = createFlow(params)

    protected abstract fun createFlow(params: P): Flow<PagingData<R>>
}